...
// and the emoji itself — it never reads the author shape (a base type must not embed
// the author's fields). `removable` is a neutral, consumer-projected instruction (same
