...
<Canvas>
    <Story name="Variant Outlined With Not Full">
        <Wrapper variant="outlined" withNoFull>With Not Full</Wrapper>
    </Story>
</Canvas>
...
<Canvas>
    <Story name="Variant Inlined With Not Full">
        <div>
            Please select <Wrapper variant="inlined" withNoFull end={<AngleDownIcon className="stroke-1"/>}>user</Wrapper> responsible for the task.
        </div>
    </Story>
</Canvas>
...
<Canvas>
    <Story name="Plain" args={{ focus: false, disabled: false, error: false, inside: 'Plain' }}>
        {Template.bind({})}
    </Story>
    <Story name="Focus" args={{ focus: true, disabled: false, error: false, inside: 'Focus' }}>
        {Template.bind({})}
    </Story>
    <Story name="Error" args={{ focus: false, disabled: false, error: true, inside: 'Error' }}>
        {Template.bind({})}
    </Story>
    <Story name="Focus Error" args={{ focus: true, disabled: false, error: true, inside: 'Focus Error' }}>
        {Template.bind({})}
    </Story>
</Canvas>
