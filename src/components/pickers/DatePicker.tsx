...
export interface DatePickerProps extends Omit<InputPopperProps, 'show' | 'onShowChange' | 'renderPopper'> {
     ...
     *
     * By default it closes — picking is the errand, and `DatePicker` selects
...
interface MonthSheetProps extends Required<Pick<DatePickerProps, 'firstDayOfWeek' | 'withShortcuts'>> {
