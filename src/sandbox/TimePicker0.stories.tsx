...
import { TimePicker0 } from './TimePicker0';


// Definition

const meta: Meta<typeof TimePicker0> = {

    component: TimePicker0,
    parameters: {
        layout: 'centered',
...
export const Controlled: Story = {
    render: (args) => <ControlledTemplate component={TimePicker0} componentProps={args} initial="8:30am" forced="2:45pm" />
};

export const Uncontrolled: Story = {
    render: (args) => <UncontrolledTemplate component={TimePicker0} componentProps={args} initial="8:30am" forced="2:45pm" />
};

export const HookForm: Story = {
    render: (args) => <HookFormTemplate component={TimePicker0} componentProps={args} initial="8:30am" forced="2:45pm" />
};
