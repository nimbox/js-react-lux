...
export interface DatePicker0Props extends Omit<InputPopperProps, 'show' | 'onShowChange' | 'renderPopper'> {
    ...
    */
     ...
     *
     * By default it closes — picking is the errand, and `DatePicker0` selects the
...
/**
 * DatePicker0. Select a date with one click.
 */
export function DatePicker0(props: DatePicker0Props & InputHTMLAttributes<HTMLInputElement>) {
...
interface CalendarProps extends Pick<DatePicker0Props, 'firstDayOfWeek' | 'withShortcuts'> {
