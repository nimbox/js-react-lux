...
export interface TimePicker0Props extends Omit<InputPopperProps, 'show' | 'onShowChange' | 'renderPopper'> {
...
/**
 * TimePicker0. Select a time with one click.
 */
export function TimePicker0(props: TimePicker0Props & React.InputHTMLAttributes<HTMLInputElement>) {
