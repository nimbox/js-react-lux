...
const SvgCircleCheck = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M14 22.5c-.456 0-.887-.207-1.17-.563l-4-5a1.5 1.5 0 0 1 2.34-1.875L14 18.6l6.83-8.536a1.499 1.499 0 1 1 2.34 1.875l-8 10A1.498 1.498 0 0 1 14 22.5Z" />
