...
const SvgBoard = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M9 19.5A1.5 1.5 0 0 1 7.5 18V7a1.5 1.5 0 1 1 3 0v11A1.5 1.5 0 0 1 9 19.5M16 15.5a1.5 1.5 0 0 1-1.5-1.5V7a1.5 1.5 0 1 1 3 0v7a1.5 1.5 0 0 1-1.5 1.5M23 23.5a1.5 1.5 0 0 1-1.5-1.5V7a1.5 1.5 0 1 1 3 0v15a1.5 1.5 0 0 1-1.5 1.5" />
