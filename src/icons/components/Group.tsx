...
const SvgGroup = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M20.5 27.5A1.5 1.5 0 0 1 19 26c0-4.411-3.364-8-7.5-8S4 21.589 4 26a1.5 1.5 0 0 1-3 0c0-6.065 4.71-11 10.5-11S22 19.935 22 26a1.5 1.5 0 0 1-1.5 1.5Z" />
