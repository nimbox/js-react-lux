...
const SvgInbox = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M28.5 30h-25C1.57 30 0 28.43 0 26.5V18c0-.212.045-.42.131-.613l5.97-13.318A3.504 3.504 0 0 1 9.296 2h13.41c1.377 0 2.63.812 3.193 2.069l5.97 13.318c.087.192.132.401.132.613v8.5c0 1.93-1.57 3.5-3.5 3.5ZM3 18.321V26.5a.5.5 0 0 0 .5.5h25a.5.5 0 0 0 .5-.5v-8.179L23.161 5.296A.501.501 0 0 0 22.705 5H9.295a.501.501 0 0 0-.456.295L3 18.322ZM7.47 4.682Z" />
